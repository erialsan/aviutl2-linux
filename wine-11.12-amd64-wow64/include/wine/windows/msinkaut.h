/*** Autogenerated by WIDL 11.12 from /home/runner/build_wine/wine/include/msinkaut.idl - Do not edit ***/
...
#endif /* defined __cplusplus */
#endif /* defined __InkRecognizerContext_FWD_DEFINED__ */
...
#endif /* defined __cplusplus */
#endif /* defined __InkRecognizers_FWD_DEFINED__ */
...
typedef struct tag_InkRecoGuide {
    tagRECT rectWritingBox;
    tagRECT rectDrawnBox;
    LONG cRows;
    LONG cColumns;
    LONG Midline;
} _InkRecoGuide;
...
typedef _InkRecoGuide InkRecoGuide;
typedef enum __WIDL_msinkaut_generated_name_00000021 {
    ...
    IRC_LinedInput = 0x8,
    IRC_BoxedInput = 0x10,
    IRC_CharacterAutoCompletionInput = 0x20,
    IRC_RightAndDown = 0x40,
    IRC_LeftAndDown = 0x80,
    IRC_DownAndLeft = 0x100,
    IRC_DownAndRight = 0x200,
    IRC_ArbitraryAngle = 0x400,
    IRC_Lattice = 0x800,
    IRC_AdviseInkChange = 0x1000,
    IRC_StrokeReorder = 0x2000,
    IRC_Personalizable = 0x4000,
    IRC_PrefersArbitraryAngle = 0x8000,
    IRC_PrefersParagraphBreaking = 0x10000,
    IRC_PrefersSegmentation = 0x20000,
    IRC_Cursive = 0x40000,
    IRC_TextPrediction = 0x80000,
    IRC_Alpha = 0x100000,
    IRC_Beta = 0x200000
...
typedef enum __WIDL_msinkaut_generated_name_00000026 {
    TPMU_Default = 0,
    TPMU_Inches = 1,
    TPMU_Centimeters = 2,
    TPMU_Degrees = 3,
...
typedef enum __WIDL_msinkaut_generated_name_00000027 {
    ICM_InkOnly = 0,
    ICM_GestureOnly = 1,
    ICM_InkAndGesture = 2
} InkCollectionMode;
typedef enum __WIDL_msinkaut_generated_name_00000028 {
    IMP_Default = 0,
    IMP_Arrow = 1,
    IMP_Crosshair = 2,
    IMP_Ibeam = 3,
...
typedef enum __WIDL_msinkaut_generated_name_00000029 {
    THWC_Integrated = 1,
...
typedef enum __WIDL_msinkaut_generated_name_0000002A {
    ICBS_Unavailable = 0,
    ICBS_Up = 1,
    ICBS_Down = 2
...
typedef enum __WIDL_msinkaut_generated_name_0000002B {
    IAG_AllGestures = 0,
    IAG_NoGesture = 61440,
...
typedef enum __WIDL_msinkaut_generated_name_0000002C {
...
DEFINE_GUID(IID_IInkWordList, 0x76ba3491, 0xcb2f, 0x406b, 0x99,0x61, 0x0e,0x0c,0x4c,0xda,0xae,0xf2);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("76ba3491-cb2f-406b-9961-0e0c4cdaaef2")
IInkWordList : public IDispatch
{
    virtual HRESULT STDMETHODCALLTYPE AddWord(
        BSTR NewWord) = 0;

    virtual HRESULT STDMETHODCALLTYPE RemoveWord(
        BSTR RemoveWord) = 0;

    virtual HRESULT STDMETHODCALLTYPE Merge(
        IInkWordList *MergeWordList) = 0;

};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IInkWordList, 0x76ba3491, 0xcb2f, 0x406b, 0x99,0x61, 0x0e,0x0c,0x4c,0xda,0xae,0xf2)
#endif
#else
typedef struct IInkWordListVtbl {
    ...
    HRESULT (STDMETHODCALLTYPE *Merge)(
        IInkWordList *This,
        IInkWordList *MergeWordList);

    END_INTERFACE
} IInkWordListVtbl;

interface IInkWordList {
    CONST_VTBL IInkWordListVtbl* lpVtbl;
};
...
#else
/*** IUnknown methods ***/
static inline HRESULT IInkWordList_QueryInterface(IInkWordList* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IInkWordList_AddRef(IInkWordList* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IInkWordList_Release(IInkWordList* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IInkWordList_GetTypeInfoCount(IInkWordList* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IInkWordList_GetTypeInfo(IInkWordList* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IInkWordList_GetIDsOfNames(IInkWordList* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IInkWordList_Invoke(IInkWordList* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IInkWordList methods ***/
static inline HRESULT IInkWordList_AddWord(IInkWordList* This,BSTR NewWord) {
    return This->lpVtbl->AddWord(This,NewWord);
}
static inline HRESULT IInkWordList_RemoveWord(IInkWordList* This,BSTR RemoveWord) {
    return This->lpVtbl->RemoveWord(This,RemoveWord);
}
static inline HRESULT IInkWordList_Merge(IInkWordList* This,IInkWordList *MergeWordList) {
    return This->lpVtbl->Merge(This,MergeWordList);
}
#endif
#endif
...
DEFINE_GUID(DIID__IInkRecognitionEvents, 0x17bce92f, 0x2e21, 0x47fd, 0x9d,0x33, 0x3c,0x6a,0xfb,0xfd,0x8c,0x59);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(_IInkRecognitionEvents, 0x17bce92f, 0x2e21, 0x47fd, 0x9d,0x33, 0x3c,0x6a,0xfb,0xfd,0x8c,0x59)
#endif
#else
...
interface _IInkRecognitionEvents {
    CONST_VTBL _IInkRecognitionEventsVtbl* lpVtbl;
};
...
#else
/*** IUnknown methods ***/
static inline HRESULT _IInkRecognitionEvents_QueryInterface(_IInkRecognitionEvents* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG _IInkRecognitionEvents_AddRef(_IInkRecognitionEvents* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG _IInkRecognitionEvents_Release(_IInkRecognitionEvents* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT _IInkRecognitionEvents_GetTypeInfoCount(_IInkRecognitionEvents* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT _IInkRecognitionEvents_GetTypeInfo(_IInkRecognitionEvents* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT _IInkRecognitionEvents_GetIDsOfNames(_IInkRecognitionEvents* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT _IInkRecognitionEvents_Invoke(_IInkRecognitionEvents* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
#endif
#endif
...
DEFINE_GUID(IID_IInkRecognizer, 0x782bf7cf, 0x034b, 0x4396, 0x8a,0x32, 0x3a,0x18,0x33,0xcf,0x6b,0x56);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IInkRecognizer : public IDispatch
{
    ...
    virtual HRESULT STDMETHODCALLTYPE get_Vendor(
        BSTR *Vendor) = 0;

    virtual HRESULT STDMETHODCALLTYPE get_Capabilities(
        InkRecognizerCapabilities *CapabilitiesFlags) = 0;

    virtual HRESULT STDMETHODCALLTYPE get_Languages(
        VARIANT *Languages) = 0;

    virtual HRESULT STDMETHODCALLTYPE get_SupportedProperties(
        VARIANT *SupportedProperties) = 0;

    virtual HRESULT STDMETHODCALLTYPE get_PreferredPacketDescription(
        VARIANT *PreferredPacketDescription) = 0;

    virtual HRESULT STDMETHODCALLTYPE CreateRecognizerContext(
        IInkRecognizerContext **Context) = 0;

};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IInkRecognizer, 0x782bf7cf, 0x034b, 0x4396, 0x8a,0x32, 0x3a,0x18,0x33,0xcf,0x6b,0x56)
#endif
#else
typedef struct IInkRecognizerVtbl {
    ...
    HRESULT (STDMETHODCALLTYPE *CreateRecognizerContext)(
        IInkRecognizer *This,
        IInkRecognizerContext **Context);

    END_INTERFACE
} IInkRecognizerVtbl;

interface IInkRecognizer {
    CONST_VTBL IInkRecognizerVtbl* lpVtbl;
};
...
#else
/*** IUnknown methods ***/
static inline HRESULT IInkRecognizer_QueryInterface(IInkRecognizer* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IInkRecognizer_AddRef(IInkRecognizer* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IInkRecognizer_Release(IInkRecognizer* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IInkRecognizer_GetTypeInfoCount(IInkRecognizer* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IInkRecognizer_GetTypeInfo(IInkRecognizer* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IInkRecognizer_GetIDsOfNames(IInkRecognizer* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IInkRecognizer_Invoke(IInkRecognizer* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IInkRecognizer methods ***/
static inline HRESULT IInkRecognizer_get_Name(IInkRecognizer* This,BSTR *Name) {
    return This->lpVtbl->get_Name(This,Name);
}
static inline HRESULT IInkRecognizer_get_Vendor(IInkRecognizer* This,BSTR *Vendor) {
    return This->lpVtbl->get_Vendor(This,Vendor);
}
static inline HRESULT IInkRecognizer_get_Capabilities(IInkRecognizer* This,InkRecognizerCapabilities *CapabilitiesFlags) {
    return This->lpVtbl->get_Capabilities(This,CapabilitiesFlags);
}
static inline HRESULT IInkRecognizer_get_Languages(IInkRecognizer* This,VARIANT *Languages) {
    return This->lpVtbl->get_Languages(This,Languages);
}
static inline HRESULT IInkRecognizer_get_SupportedProperties(IInkRecognizer* This,VARIANT *SupportedProperties) {
    return This->lpVtbl->get_SupportedProperties(This,SupportedProperties);
}
static inline HRESULT IInkRecognizer_get_PreferredPacketDescription(IInkRecognizer* This,VARIANT *PreferredPacketDescription) {
    return This->lpVtbl->get_PreferredPacketDescription(This,PreferredPacketDescription);
}
static inline HRESULT IInkRecognizer_CreateRecognizerContext(IInkRecognizer* This,IInkRecognizerContext **Context) {
    return This->lpVtbl->CreateRecognizerContext(This,Context);
}
#endif
#endif
...
DEFINE_GUID(IID_IInkRecognizer2, 0x6110118a, 0x3a75, 0x4ad6, 0xb2,0xaa, 0x04,0xb2,0xb7,0x2b,0xbe,0x65);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IInkRecognizer2 : public IDispatch
{
    ...
    virtual HRESULT STDMETHODCALLTYPE get_UnicodeRanges(
        VARIANT *UnicodeRanges) = 0;

};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IInkRecognizer2, 0x6110118a, 0x3a75, 0x4ad6, 0xb2,0xaa, 0x04,0xb2,0xb7,0x2b,0xbe,0x65)
#endif
#else
...
interface IInkRecognizer2 {
    CONST_VTBL IInkRecognizer2Vtbl* lpVtbl;
};
...
#else
/*** IUnknown methods ***/
static inline HRESULT IInkRecognizer2_QueryInterface(IInkRecognizer2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IInkRecognizer2_AddRef(IInkRecognizer2* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IInkRecognizer2_Release(IInkRecognizer2* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IInkRecognizer2_GetTypeInfoCount(IInkRecognizer2* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IInkRecognizer2_GetTypeInfo(IInkRecognizer2* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IInkRecognizer2_GetIDsOfNames(IInkRecognizer2* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IInkRecognizer2_Invoke(IInkRecognizer2* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IInkRecognizer2 methods ***/
static inline HRESULT IInkRecognizer2_get_Id(IInkRecognizer2* This,BSTR *pbstrId) {
    return This->lpVtbl->get_Id(This,pbstrId);
}
static inline HRESULT IInkRecognizer2_get_UnicodeRanges(IInkRecognizer2* This,VARIANT *UnicodeRanges) {
    return This->lpVtbl->get_UnicodeRanges(This,UnicodeRanges);
}
#endif
#endif
...
DEFINE_GUID(IID_IInkRecognizerGuide, 0xd934be07, 0x7b84, 0x4208, 0x91,0x36, 0x83,0xc2,0x09,0x94,0xe9,0x05);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("d934be07-7b84-4208-9136-83c20994e905")
IInkRecognizerGuide : public IDispatch
{
    virtual HRESULT STDMETHODCALLTYPE get_WritingBox(
        IInkRectangle **Rectangle) = 0;

    virtual HRESULT STDMETHODCALLTYPE put_WritingBox(
        IInkRectangle *Rectangle) = 0;

    virtual HRESULT STDMETHODCALLTYPE get_DrawnBox(
        IInkRectangle **Rectangle) = 0;

    virtual HRESULT STDMETHODCALLTYPE put_DrawnBox(
        IInkRectangle *Rectangle) = 0;
    ...
    virtual HRESULT STDMETHODCALLTYPE put_Midline(
        LONG Units) = 0;

    virtual HRESULT STDMETHODCALLTYPE get_GuideData(
        InkRecoGuide *pRecoGuide) = 0;

    virtual HRESULT STDMETHODCALLTYPE put_GuideData(
        InkRecoGuide pRecoGuide) = 0;

};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IInkRecognizerGuide, 0xd934be07, 0x7b84, 0x4208, 0x91,0x36, 0x83,0xc2,0x09,0x94,0xe9,0x05)
#endif
#else
...
interface IInkRecognizerGuide {
    CONST_VTBL IInkRecognizerGuideVtbl* lpVtbl;
};
...
#define IInkRecognizerGuide_put_GuideData(This,pRecoGuide) (This)->lpVtbl->put_GuideData(This,pRecoGuide)
#else
/*** IUnknown methods ***/
static inline HRESULT IInkRecognizerGuide_QueryInterface(IInkRecognizerGuide* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IInkRecognizerGuide_AddRef(IInkRecognizerGuide* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IInkRecognizerGuide_Release(IInkRecognizerGuide* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IInkRecognizerGuide_GetTypeInfoCount(IInkRecognizerGuide* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IInkRecognizerGuide_GetTypeInfo(IInkRecognizerGuide* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IInkRecognizerGuide_GetIDsOfNames(IInkRecognizerGuide* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IInkRecognizerGuide_Invoke(IInkRecognizerGuide* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IInkRecognizerGuide methods ***/
static inline HRESULT IInkRecognizerGuide_get_WritingBox(IInkRecognizerGuide* This,IInkRectangle **Rectangle) {
    return This->lpVtbl->get_WritingBox(This,Rectangle);
}
static inline HRESULT IInkRecognizerGuide_put_WritingBox(IInkRecognizerGuide* This,IInkRectangle *Rectangle) {
    return This->lpVtbl->put_WritingBox(This,Rectangle);
}
static inline HRESULT IInkRecognizerGuide_get_DrawnBox(IInkRecognizerGuide* This,IInkRectangle **Rectangle) {
    return This->lpVtbl->get_DrawnBox(This,Rectangle);
}
static inline HRESULT IInkRecognizerGuide_put_DrawnBox(IInkRecognizerGuide* This,IInkRectangle *Rectangle) {
    return This->lpVtbl->put_DrawnBox(This,Rectangle);
}
static inline HRESULT IInkRecognizerGuide_get_Rows(IInkRecognizerGuide* This,LONG *Units) {
    return This->lpVtbl->get_Rows(This,Units);
}
static inline HRESULT IInkRecognizerGuide_put_Rows(IInkRecognizerGuide* This,LONG Units) {
    return This->lpVtbl->put_Rows(This,Units);
}
static inline HRESULT IInkRecognizerGuide_get_Columns(IInkRecognizerGuide* This,LONG *Units) {
    return This->lpVtbl->get_Columns(This,Units);
}
static inline HRESULT IInkRecognizerGuide_put_Columns(IInkRecognizerGuide* This,LONG Units) {
    return This->lpVtbl->put_Columns(This,Units);
}
static inline HRESULT IInkRecognizerGuide_get_Midline(IInkRecognizerGuide* This,LONG *Units) {
    return This->lpVtbl->get_Midline(This,Units);
}
static inline HRESULT IInkRecognizerGuide_put_Midline(IInkRecognizerGuide* This,LONG Units) {
    return This->lpVtbl->put_Midline(This,Units);
}
static inline HRESULT IInkRecognizerGuide_get_GuideData(IInkRecognizerGuide* This,InkRecoGuide *pRecoGuide) {
    return This->lpVtbl->get_GuideData(This,pRecoGuide);
}
static inline HRESULT IInkRecognizerGuide_put_GuideData(IInkRecognizerGuide* This,InkRecoGuide pRecoGuide) {
    return This->lpVtbl->put_GuideData(This,pRecoGuide);
}
#endif
#endif
...
DEFINE_GUID(IID_IInkRecognizerContext, 0xc68f52f9, 0x32a3, 0x4625, 0x90,0x6c, 0x44,0xfc,0x23,0xb4,0x09,0x58);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IInkRecognizerContext : public IDispatch
{
    ...
    virtual HRESULT STDMETHODCALLTYPE putref_Strokes(
        IInkStrokes *Strokes) = 0;

    virtual HRESULT STDMETHODCALLTYPE get_CharacterAutoCompletionMode(
        InkRecognizerCharacterAutoCompletionMode *Mode) = 0;

    virtual HRESULT STDMETHODCALLTYPE put_CharacterAutoCompletionMode(
        InkRecognizerCharacterAutoCompletionMode Mode) = 0;

    virtual HRESULT STDMETHODCALLTYPE get_Factoid(
        BSTR *Factoid) = 0;

    virtual HRESULT STDMETHODCALLTYPE put_Factoid(
        BSTR Factoid) = 0;

    virtual HRESULT STDMETHODCALLTYPE get_Guide(
        IInkRecognizerGuide **RecognizerGuide) = 0;

    virtual HRESULT STDMETHODCALLTYPE putref_Guide(
        IInkRecognizerGuide *RecognizerGuide) = 0;

    virtual HRESULT STDMETHODCALLTYPE get_PrefixText(
        BSTR *Prefix) = 0;

    virtual HRESULT STDMETHODCALLTYPE put_PrefixText(
        BSTR Prefix) = 0;

    virtual HRESULT STDMETHODCALLTYPE get_SuffixText(
        BSTR *Suffix) = 0;

    virtual HRESULT STDMETHODCALLTYPE put_SuffixText(
        BSTR Suffix) = 0;

    virtual HRESULT STDMETHODCALLTYPE get_RecognitionFlags(
        InkRecognitionModes *Modes) = 0;

    virtual HRESULT STDMETHODCALLTYPE put_RecognitionFlags(
        InkRecognitionModes Modes) = 0;

    virtual HRESULT STDMETHODCALLTYPE get_WordList(
        IInkWordList **WordList) = 0;

    virtual HRESULT STDMETHODCALLTYPE putref_WordList(
        IInkWordList *WordList) = 0;

    virtual HRESULT STDMETHODCALLTYPE get_Recognizer(
        IInkRecognizer **Recognizer) = 0;

    virtual HRESULT STDMETHODCALLTYPE Recognize(
        InkRecognitionStatus *RecognitionStatus,
        IInkRecognitionResult **RecognitionResult) = 0;

    virtual HRESULT STDMETHODCALLTYPE StopBackgroundRecognition(
        ) = 0;

    virtual HRESULT STDMETHODCALLTYPE EndInkInput(
        ) = 0;

    virtual HRESULT STDMETHODCALLTYPE BackgroundRecognize(
        VARIANT CustomData) = 0;

    virtual HRESULT STDMETHODCALLTYPE BackgroundRecognizeWithAlternates(
        VARIANT CustomData) = 0;

    virtual HRESULT STDMETHODCALLTYPE Clone(
        IInkRecognizerContext **RecoContext) = 0;

    virtual HRESULT STDMETHODCALLTYPE IsStringSupported(
        BSTR String,
        VARIANT_BOOL *Supported) = 0;

};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IInkRecognizerContext, 0xc68f52f9, 0x32a3, 0x4625, 0x90,0x6c, 0x44,0xfc,0x23,0xb4,0x09,0x58)
#endif
#else
typedef struct IInkRecognizerContextVtbl {
    ...
    HRESULT (STDMETHODCALLTYPE *Clone)(
        IInkRecognizerContext *This,
        IInkRecognizerContext **RecoContext);
...
interface IInkRecognizerContext {
    CONST_VTBL IInkRecognizerContextVtbl* lpVtbl;
};
...
#else
/*** IUnknown methods ***/
static inline HRESULT IInkRecognizerContext_QueryInterface(IInkRecognizerContext* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IInkRecognizerContext_AddRef(IInkRecognizerContext* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IInkRecognizerContext_Release(IInkRecognizerContext* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IInkRecognizerContext_GetTypeInfoCount(IInkRecognizerContext* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IInkRecognizerContext_GetTypeInfo(IInkRecognizerContext* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IInkRecognizerContext_GetIDsOfNames(IInkRecognizerContext* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IInkRecognizerContext_Invoke(IInkRecognizerContext* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IInkRecognizerContext methods ***/
static inline HRESULT IInkRecognizerContext_get_Strokes(IInkRecognizerContext* This,IInkStrokes **Strokes) {
    return This->lpVtbl->get_Strokes(This,Strokes);
}
static inline HRESULT IInkRecognizerContext_putref_Strokes(IInkRecognizerContext* This,IInkStrokes *Strokes) {
    return This->lpVtbl->putref_Strokes(This,Strokes);
}
static inline HRESULT IInkRecognizerContext_get_CharacterAutoCompletionMode(IInkRecognizerContext* This,InkRecognizerCharacterAutoCompletionMode *Mode) {
    return This->lpVtbl->get_CharacterAutoCompletionMode(This,Mode);
}
static inline HRESULT IInkRecognizerContext_put_CharacterAutoCompletionMode(IInkRecognizerContext* This,InkRecognizerCharacterAutoCompletionMode Mode) {
    return This->lpVtbl->put_CharacterAutoCompletionMode(This,Mode);
}
static inline HRESULT IInkRecognizerContext_get_Factoid(IInkRecognizerContext* This,BSTR *Factoid) {
    return This->lpVtbl->get_Factoid(This,Factoid);
}
static inline HRESULT IInkRecognizerContext_put_Factoid(IInkRecognizerContext* This,BSTR Factoid) {
    return This->lpVtbl->put_Factoid(This,Factoid);
}
static inline HRESULT IInkRecognizerContext_get_Guide(IInkRecognizerContext* This,IInkRecognizerGuide **RecognizerGuide) {
    return This->lpVtbl->get_Guide(This,RecognizerGuide);
}
static inline HRESULT IInkRecognizerContext_putref_Guide(IInkRecognizerContext* This,IInkRecognizerGuide *RecognizerGuide) {
    return This->lpVtbl->putref_Guide(This,RecognizerGuide);
}
static inline HRESULT IInkRecognizerContext_get_PrefixText(IInkRecognizerContext* This,BSTR *Prefix) {
    return This->lpVtbl->get_PrefixText(This,Prefix);
}
static inline HRESULT IInkRecognizerContext_put_PrefixText(IInkRecognizerContext* This,BSTR Prefix) {
    return This->lpVtbl->put_PrefixText(This,Prefix);
}
static inline HRESULT IInkRecognizerContext_get_SuffixText(IInkRecognizerContext* This,BSTR *Suffix) {
    return This->lpVtbl->get_SuffixText(This,Suffix);
}
static inline HRESULT IInkRecognizerContext_put_SuffixText(IInkRecognizerContext* This,BSTR Suffix) {
    return This->lpVtbl->put_SuffixText(This,Suffix);
}
static inline HRESULT IInkRecognizerContext_get_RecognitionFlags(IInkRecognizerContext* This,InkRecognitionModes *Modes) {
    return This->lpVtbl->get_RecognitionFlags(This,Modes);
}
static inline HRESULT IInkRecognizerContext_put_RecognitionFlags(IInkRecognizerContext* This,InkRecognitionModes Modes) {
    return This->lpVtbl->put_RecognitionFlags(This,Modes);
}
static inline HRESULT IInkRecognizerContext_get_WordList(IInkRecognizerContext* This,IInkWordList **WordList) {
    return This->lpVtbl->get_WordList(This,WordList);
}
static inline HRESULT IInkRecognizerContext_putref_WordList(IInkRecognizerContext* This,IInkWordList *WordList) {
    return This->lpVtbl->putref_WordList(This,WordList);
}
static inline HRESULT IInkRecognizerContext_get_Recognizer(IInkRecognizerContext* This,IInkRecognizer **Recognizer) {
    return This->lpVtbl->get_Recognizer(This,Recognizer);
}
static inline HRESULT IInkRecognizerContext_Recognize(IInkRecognizerContext* This,InkRecognitionStatus *RecognitionStatus,IInkRecognitionResult **RecognitionResult) {
    return This->lpVtbl->Recognize(This,RecognitionStatus,RecognitionResult);
}
static inline HRESULT IInkRecognizerContext_StopBackgroundRecognition(IInkRecognizerContext* This) {
    return This->lpVtbl->StopBackgroundRecognition(This);
}
static inline HRESULT IInkRecognizerContext_EndInkInput(IInkRecognizerContext* This) {
    return This->lpVtbl->EndInkInput(This);
}
static inline HRESULT IInkRecognizerContext_BackgroundRecognize(IInkRecognizerContext* This,VARIANT CustomData) {
    return This->lpVtbl->BackgroundRecognize(This,CustomData);
}
static inline HRESULT IInkRecognizerContext_BackgroundRecognizeWithAlternates(IInkRecognizerContext* This,VARIANT CustomData) {
    return This->lpVtbl->BackgroundRecognizeWithAlternates(This,CustomData);
}
static inline HRESULT IInkRecognizerContext_Clone(IInkRecognizerContext* This,IInkRecognizerContext **RecoContext) {
    return This->lpVtbl->Clone(This,RecoContext);
}
static inline HRESULT IInkRecognizerContext_IsStringSupported(IInkRecognizerContext* This,BSTR String,VARIANT_BOOL *Supported) {
    return This->lpVtbl->IsStringSupported(This,String,Supported);
}
#endif
#endif
...
DEFINE_GUID(IID_IInkRecognizers, 0x9ccc4f12, 0xb0b7, 0x4a8b, 0xbf,0x58, 0x4a,0xec,0xa4,0xe8,0xce,0xfd);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IInkRecognizers : public IDispatch
{
    ...
    virtual HRESULT STDMETHODCALLTYPE GetDefaultRecognizer(
        LONG lcid,
        IInkRecognizer **DefaultRecognizer) = 0;

    virtual HRESULT STDMETHODCALLTYPE Item(
        LONG Index,
        IInkRecognizer **InkRecognizer) = 0;

};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IInkRecognizers, 0x9ccc4f12, 0xb0b7, 0x4a8b, 0xbf,0x58, 0x4a,0xec,0xa4,0xe8,0xce,0xfd)
#endif
#else
typedef struct IInkRecognizersVtbl {
    ...
    HRESULT (STDMETHODCALLTYPE *GetDefaultRecognizer)(
        IInkRecognizers *This,
        LONG lcid,
        IInkRecognizer **DefaultRecognizer);

    HRESULT (STDMETHODCALLTYPE *Item)(
        IInkRecognizers *This,
        LONG Index,
        IInkRecognizer **InkRecognizer);

    END_INTERFACE
} IInkRecognizersVtbl;

interface IInkRecognizers {
    CONST_VTBL IInkRecognizersVtbl* lpVtbl;
};
...
/*** IInkRecognizers methods ***/
#define IInkRecognizers_Count(This,Count) (This)->lpVtbl->Count(This,Count)
#define IInkRecognizers__NewEnum(This,_NewEnum) (This)->lpVtbl->_NewEnum(This,_NewEnum)
...
#else
/*** IUnknown methods ***/
static inline HRESULT IInkRecognizers_QueryInterface(IInkRecognizers* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IInkRecognizers_AddRef(IInkRecognizers* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IInkRecognizers_Release(IInkRecognizers* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IInkRecognizers_GetTypeInfoCount(IInkRecognizers* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IInkRecognizers_GetTypeInfo(IInkRecognizers* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IInkRecognizers_GetIDsOfNames(IInkRecognizers* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IInkRecognizers_Invoke(IInkRecognizers* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IInkRecognizers methods ***/
static inline HRESULT IInkRecognizers_Count(IInkRecognizers* This,LONG *Count) {
    return This->lpVtbl->Count(This,Count);
}
static inline HRESULT IInkRecognizers__NewEnum(IInkRecognizers* This,IUnknown **_NewEnum) {
    return This->lpVtbl->_NewEnum(This,_NewEnum);
}
static inline HRESULT IInkRecognizers_GetDefaultRecognizer(IInkRecognizers* This,LONG lcid,IInkRecognizer **DefaultRecognizer) {
    return This->lpVtbl->GetDefaultRecognizer(This,lcid,DefaultRecognizer);
}
static inline HRESULT IInkRecognizers_Item(IInkRecognizers* This,LONG Index,IInkRecognizer **InkRecognizer) {
    return This->lpVtbl->Item(This,Index,InkRecognizer);
}
#endif
#endif
...
/*****************************************************************************
 * InkRecognizerContext coclass
 */

DEFINE_GUID(CLSID_InkRecognizerContext, 0xaac46a37, 0x9229, 0x4fc0, 0x8c,0xce, 0x44,0x97,0x56,0x9b,0xf4,0xd1);

#ifdef __cplusplus
class DECLSPEC_UUID("aac46a37-9229-4fc0-8cce-4497569bf4d1") InkRecognizerContext;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(InkRecognizerContext, 0xaac46a37, 0x9229, 0x4fc0, 0x8c,0xce, 0x44,0x97,0x56,0x9b,0xf4,0xd1)
#endif
#endif

/*****************************************************************************
 * InkRecognizers coclass
 */

DEFINE_GUID(CLSID_InkRecognizers, 0x9fd4e808, 0xf6e6, 0x4e65, 0x98,0xd3, 0xaa,0x39,0x05,0x4c,0x12,0x55);

#ifdef __cplusplus
class DECLSPEC_UUID("9fd4e808-f6e6-4e65-98d3-aa39054c1255") InkRecognizers;
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(InkRecognizers, 0x9fd4e808, 0xf6e6, 0x4e65, 0x98,0xd3, 0xaa,0x39,0x05,0x4c,0x12,0x55)
#endif
#endif
