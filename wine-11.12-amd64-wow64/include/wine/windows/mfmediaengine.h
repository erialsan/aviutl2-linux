/*** Autogenerated by WIDL 11.12 from /home/runner/build_wine/wine/include/mfmediaengine.idl - Do not edit ***/
...
{
    virtual BOOL STDMETHODCALLTYPE GetUpdating(
        ) = 0;
...
/*** IMFSourceBuffer methods ***/
static inline BOOL IMFSourceBuffer_GetUpdating(IMFSourceBuffer* This) {
...
static inline BOOL IMFMediaSourceExtension_IsTypeSupported(IMFMediaSourceExtension* This,BSTR type) {
...
static inline HRESULT IMFMediaEngineClassFactoryEx_IsTypeSupported(IMFMediaEngineClassFactoryEx* This,BSTR type,BSTR key_system,BOOL *is_supported) {
